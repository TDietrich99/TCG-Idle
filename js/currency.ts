...
export class bigNumber{
    ...
    getSaveData():BigNumberSave{
        return{
            e: this.e,
            m: this.m
        };
    }
    loadSaveData(data:BigNumberSave){
        this.m = data.m;
        this.e = data.e;
    }
    display(){
    ...
    transformToBn(num2: number):bigNumber{ 
    ...
    multiply(other: number): void;
    multiply(other: bigNumber): void;
    ...
    add(other: any): void {
        ...
        if (ediff < -EQUALTOLLERANCE) return;
